...
//KIC-s
	if (PageGced(folio_page(folio, 0))) {
//		printk(KERN_ALERT"%s root num = %p \n",__FUNCTION__,folio_page(folio, 0));
		fio->io_type = FS_GC_DATA_IO;
		ClearPageGced(folio_page(folio, 0));
	}
//KIC-o
